...
import com.ash.services.ConverterService;
import com.ash.services.GifEncoderService;
import com.ash.services.VideoDecoderService;
...
public class UploadController {
	...
	public String upload(@RequestPart("file") MultipartFile file,
		...
		log.info("Saved file to 4 {}", videoFile.getAbsolutePath());
